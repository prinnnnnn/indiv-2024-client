          ...
          <li className="flex">
            ...
            Kanisorn Puttaruksa
                ...
                <div className="flex gap-4 items-center flex-col sm:flex-row mx-auto">
                    <a
                        className="rounded-full border bg-[#1DA1F2] dark:bg-orange-500 font-bold border-solid border-transparent transition-colors flex items-center justify-center bg-foreground text-background gap-2 hover:bg-blue-300 hover:text-lg dark:hover:bg-orange-300 text-sm sm:text-base h-10 sm:h-12 px-4 sm:px-5"
                        href="/login"
                    >
                        Log In
                    </a>
                    <a
                        className="rounded-full border border-solid border-black/[.08] dark:border-white/[.145] transition-colors flex items-center justify-center hover:bg-[#f2f2f2] dark:hover:bg-[#1a1a1a] hover:text-lg hover:border-transparent text-sm sm:text-base h-10 sm:h-12 px-4 sm:px-5 sm:min-w-[80]"
                        href="/signup"
                    >
                        Register
                    </a>
