    ...
    <form onSubmit={handleSubmit} className="space-y-3 w-full">
      ...
      <div className="">
        <button
          ...
          className="mx-auto rounded-lg border border-solid border-black/[.08] dark:border-white/[.145] transition-colors flex items-center justify-center hover:bg-[#f2f2f2] dark:bg-orange-500 dark:hover:bg-orange-400 dark:text-black hover:text-lg hover:border-transparent text-sm sm:text-base h-8 sm:h-10 px-4 sm:px-5 sm:min-w-44"
        >
